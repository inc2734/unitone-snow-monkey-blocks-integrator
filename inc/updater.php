...
add_action(
	...
	function () {
		new Updater(
			plugin_basename( UNITONE_SNOW_MONKEY_BLOCKS_INTEGRATOR_PATH . '/unitone-snow-monkey-blocks-integrator.php' ),
			'inc2734',
 ...
 */
add_filter(
	'inc2734_github_plugin_updater_zip_url_inc2734/unitone-snow-monkey-blocks-integrator',
	function ( $url ) {
 ...
 * Access https://unitone.2inc.org/wp-json/unitone-license-manager/v1/update/...?repository=unitone-snow-monkey-blocks-integrator
 * and return json after authentication passes.
 *
 * @return string
 */
add_filter(
	'inc2734_github_plugin_updater_request_url_inc2734/unitone-snow-monkey-blocks-integrator',
	function () {
		$license_key = Manager::get_option( 'license-key' );
		return sprintf(
			'https://unitone.2inc.org/wp-json/unitone-license-manager/v1/update/%1$s?repository=unitone-snow-monkey-blocks-integrator',
